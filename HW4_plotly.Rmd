...
* In general, most cafes are located in lower Manhattan. This is expected, as it is more populous and affluent than other areas of this borough. It seems like most cafes are generally in the lower range of violation scores.
...
* There is no distinct seasonality to mean violation scores over time. In general, the scores average within a similar range, particuarly for 2016 and onwards.
